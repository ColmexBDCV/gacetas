...
$sortLinks[__('Fecha de publicación')] = 'Dublin Core,Date';
...
<!-- esto agrega el año de edición a la vista de resumen -->
    <?php if ($description2 = metadata('item', array('Dublin Core', 'Date'), array('snippet'=>250))): ?>
    <div class="item-description">
