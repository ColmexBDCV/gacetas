...
<?php //echo head(array('title' => metadata('item', array('Item Type Metadata', 'Título')),'bodyclass' => 'item show')); ?>
...
<?php 	//all_element_texts('item',array('show_element_sets' => array('Dublin Core')));
	//echo all_element_texts('item',array('show_empty_elements' => 'Sin Dato'));
	echo all_element_texts('item',array('show_empty_elements' => false ));?>
