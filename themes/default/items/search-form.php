...
<form <?php echo tag_attributes($formAttributes); ?>>
	...
	/*Lo comentó Eli
	Basicamente se guarda en un array el valor del índice dado por # => 'nombre a desplegar', y el orden en que se 	meten en en array es respetado, esto funciona gracias a que # es el id del campo en la BD*/
	$showElementos = array(""=> 'Selecciona',39 => 'Autor', 185 => 'Cargo / Actividad / Orden',50 => 'Título',49=>'Materia',38=>'Lugar de publicación',45 => 'Impresor',40=>'Año de publicación',181=>'Ubicación de la imprenta',192=>'Lugar de venta',182=>'Nombre de la sección',43 => 'Catálogos',179 =>'Fecha de la Gaceta',183=>'Número de la Gaceta');
	$ArrayElementos = get_table_options('Element', null, array(
                        'record_types' => array('Item', 'All'),
                        'sort' => 'orderBySet')); /*esto es parte de la función origianal, se extrajo del form y en su lugar se puso una variable*/
       	// var_dump($ArrayElementos);//muestra el indice de cada elemento, esto se uso para llenar showElementos
                
         /*Codigo obtenido de : http://omeka.org/forums-legacy/topic/limit-advanced-search-to-specific-fields*/
        ...
        foreach ($search as $i => $rows): ?>
            <div class="search-entry">
                ...
                echo $this->formSelect(
                    ...
                    /*lo toma eli*/
                    //$ArrayElementos
                    $showElementos/*esto es lo que se muestra en el form, esta variable es el array que se lleno manuealmente en la linea 37*/
                );
                echo $this->formSelect(
                    "advanced[$i][type]",
                    @$rows['type'],
                    ...
                    label_table_options(array(
                        'contains' => __('contiene'),
                        'does not contain' => __('no contiene'),
                        'is exactly' => __('es exactamente'),
                        'is empty' => __('está vacío'),
                        'is not empty' => __('no está vacío'),
                        'starts with' => __('inicia con'),
                        'ends with' => __('termina con'))
                    )
                );
                echo $this->formText(
                    "advanced[$i][terms]",
